...
This project is in Maintenance mode. The new version of PHP API is available at [`allure-framework/allure-php-commons`](https://github.com/allure-framework/allure-php-commons2).
