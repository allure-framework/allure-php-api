...
//                    foreach (self::stepsFromDefinition($definition, $this, $testCase) as $step) {
...
//    }
//
//    private static function executeStepLogic($name, $fn, TestSuite $testSuite, TestCase $testCase)
//    {
//        if (is_callable($fn)) {
//            try {
//                $fn($testSuite, $testCase);
...
//            }
//        }
//        throw new AllureException("Step $name logic should be an anonymous function.");
//    }
